...
public class RegistroService {
    ...
    public Model activar(Model model, String username, String clave) {
        Optional<Usuario> usuario = usuarioService.getUsuarioPorEmailYPassword(username, clave);
    ...
    public Model crearUsuario(Model model, Usuario usuario) throws MessagingException {
        ...
        try {
            ...
            usuarioService.save(usuario, false); // raw password stored so activation link lookup works
    ...
    public Model recordarUsuario(Model model, Usuario usuario)
        ...
        String mensaje;
        Optional<Usuario> usuarioOpt = usuarioService.getUsuarioPorNombreOEmail(usuario.getNombre(), usuario.getEmail());
    ...
    private void enviaCorreoActivar(Usuario usuario, String clave) throws MessagingException {
        ...
        mensaje = String.format(mensaje, usuario.getNombre(), servidor, usuario.getEmail(), clave);
